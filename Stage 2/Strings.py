...
#Exemple strings and numbers

name = "Jonathan"
print ("Hello " + name + "!"*3) 

#You can multiply a string by a number but you can't do "String" + Number.
#However you can add a string to another string even if one of the string is a variable.
#This is called Concatention
